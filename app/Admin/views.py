            ...
            try:
                ...
                if cover_image:
                    if cover_image.filename != '':
                        ...
                        cover_image.save(os.path.join(os.environ.get("UPLOAD_FOLDER"),cover_image_name))
                        new_cover_image_name = os.path.join(os.environ.get("UPLOAD_FOLDER"),cover_image_name)
                ...
                cursor.execute('''INSERT INTO bootcamps(title,description,objective,mode,instructor,outcome,
                            ...
                            (title,description,objective,mode,instructor,outcome,hours_per_day,total_duration,cover_image_url,
